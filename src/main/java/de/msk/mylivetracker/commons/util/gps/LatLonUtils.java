package de.msk.mylivetracker.commons.util.gps;
...
public class LatLonUtils {
	...
	public enum AxisDir {
		...
		public static AxisDir get(double decimal, PosType posType) {
			return posType.equals(PosType.Latitude) ? 
				((decimal > 0d) ? AxisDir.North : AxisDir.South) :
				((decimal > 0d) ? AxisDir.East : AxisDir.West);
		}
	}
	...
	public static Wgs84Dsc decToWgs84(double decimal, PosType posType) {
		...
		return new Wgs84Dsc(wgs84Val, AxisDir.get(decimal, posType));
	}
